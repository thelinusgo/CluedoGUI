...
public class CluedoGame implements MouseListener{
	...
	///////////////////////////////////////////////////////////////
	/**
	 * NOTE: THIS IS THE START OF THE JFRAME METHODS
	 */
	...
	public void askPlayers() {
		...
		this.askCharacters(Integer.parseInt(numPlayers));
	}
	 ...
	 * @param numPlayers
	 */
	private void askCharacters(int numPlayers){
		...
		for (int i = 0; i != (numPlayers); ++i) {
			...
			this.addPlayer(playerInProgress);
		}
